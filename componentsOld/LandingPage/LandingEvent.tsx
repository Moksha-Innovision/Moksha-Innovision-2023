...
const LandingEvent = () => {
  return (
    <div className=" relative h-fit  pt-[200px] sm:pt-[35%]  md:pt-[250px] lg:pt-[300px]">
      <div className="absolute  -top-8 h-[100vh]  w-full bg-LandingEvent bg-cover bg-top bg-no-repeat"></div>
