...
const EventCards = ({ event, active }: Props) => {
  ...
  return (
    <div className="w-[560px]  h-[560px] flex flex-col justify-center items-center">
      <div className={`${active ? "z-20" : "scale-75"} w-[550px]  h-[550px] mr-80 transition-[transform] duration-300  flex flex-col justify-center items-center relative    box-content`}>
        <div
          className={`${active ? "" : ""
